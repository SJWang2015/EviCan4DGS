...
class DeformableGaussians(VanillaGaussians):
    ...
    # def get_gaussians(self, cam: dataclass_camera, src_pcs: torch.Tensor, tgt_pcs: torch.Tensor, processed_cam_list: List[torch.Tensor],
    #     human_masks_list: List[torch.Tensor], render_fn=None) -> Dict:
